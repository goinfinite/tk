...
func TestNewUnixFileName(t *testing.T) {
	t.Run("StringInputStrict", func(t *testing.T) {
		testCaseStructs := []struct {
			...
			{"*.md", UnixFileName("*.md"), false},
			{"*.txt", UnixFileName("*.txt"), false},
			{"*.sample", UnixFileName("*.sample"), false},
			{"composer*", UnixFileName("composer*"), false},
			{"*.php", UnixFileName("*.php"), false},
			{"LICENSE*", UnixFileName("LICENSE*"), false},
			{"composer.*", UnixFileName("composer.*"), false},
			{"wp-*", UnixFileName("wp-*"), false},
			{123, UnixFileName("123"), false},
			{true, UnixFileName("true"), false},
			{"~backup", UnixFileName("~backup"), false},
			...
			{"*", UnixFileName(""), true},
			{"**", UnixFileName(""), true},
			{"file**.md", UnixFileName(""), true},
			{"**.php", UnixFileName(""), true},
			{".", UnixFileName(""), true},
			{"..", UnixFileName(""), true},
			{"/", UnixFileName(""), true},
			{"\\", UnixFileName(""), true},
