...
`src/domain/README.md`, `src/infra/README.md`, and `src/presentation/README.md` document each layer's components. `skills/tk-usage/SKILL.md` routes consumer agents to them.
