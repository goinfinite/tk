...
refactor: extract the page-count rule to PaginationPagesTotalResolver(itemsTotal, itemsPerPage). A partial page counts as a page. Zero page size fails with ErrItemsPerPageCannotBeZero, checked only in the resolver.
