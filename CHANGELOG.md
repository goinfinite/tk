...
fix: FileClerk.FileContentRegexReplace and FileClerk.AppendFileContent open targets non-blocking, so a FIFO swapped in at the target name cannot hang them; the append path fails with ErrTargetNotRegularFile.
